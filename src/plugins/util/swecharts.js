...
var defaultTheme = {
    ...
    textColor: "#ABABAB",
    fillColor: "#5fbeaa",
    font: "微软雅黑, Arial, Verdana, sans-serif"
}
...
var action = {
    ...
    init: function(ele, theme) {
        var _this = this;
        echarts.registerTheme('default', _this.theme);
        if (!theme) theme = 'default';
        return echarts.init(document.getElementById(ele), theme)
    }
}
