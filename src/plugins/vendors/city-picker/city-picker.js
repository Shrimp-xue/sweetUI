    ...
    CityPicker.prototype = {
        ...
        close: function(blur) {
            ...
            if (blur) {
                ...
                var province = this.$textspan.find('[data-count="province"]').text(),
                    city = this.$textspan.find('[data-count="city"]').text(),
                    district = this.$textspan.find('[data-count="district"]').text();
                if(typeof this.options.afterClose === "function") this.options.afterClose(province,city,district);
            }
            
        },
        closeByGetData:function(){
            this.$dropdown.hide();
            this.$textspan.removeClass('open');
            this.$textspan.removeClass('focus');
            var province = this.$textspan.find('[data-count="province"]').text(),
